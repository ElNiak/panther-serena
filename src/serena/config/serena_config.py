...
class ProjectConfig(SharedConfig):
    ...
    def autogenerate(
        ...
        with LogTime("Project configuration auto-generation", logger=log):
            ...
            config_instance = cls._from_dict(config_with_comments, local_override_keys=[])
    ...
    def _from_dict(cls, data: dict[str, Any], local_override_keys: list[str]) -> Self:
        ...
        return cls(
            ...
            ivy_include_paths=data.get("ivy_include_paths", []),
            ivy_exclude_paths=data.get("ivy_exclude_paths", ["submodules", "test"]),
